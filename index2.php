...
$sth = $pdo->prepare($sql);
$sth->bindParam(':joinnbufc_event_id', $_GET['id'], PDO::PARAM_INT);
$sth->execute();
$row = $sth->rowCount();
if ($row == 0) {
    echo "<META http-equiv='refresh' content='0;URL=  error.php?action=notevent'> ";
    exit();
}
foreach ($sth as $event);
if ($datetime < $event['joinnbufc_event_ondate']) {   // ยังไม่เปิด
    echo "<META http-equiv='refresh' content='0;URL=  error.php?action=beforstart'> ";
    exit();
} else if ($datetime > $event['joinnbufc_event_offdate']) {   // หมดเขตแล้ว
...
<body>
            ...
            <form method="POST" action="manage.php">
                ...
                <div class="row">
                    <div class="col-12 col-md-5 mt-3">
                        <label for="joinnbufc_register_name" class="form-label">ชื่อ</label>
                    ...
                    <div class="col-12 col-md-5 mt-3">
                        <label for="joinnbufc_register_surname" class="form-label">นามสกุล</label>
                        <input type="text" class="form-control" id="joinnbufc_register_surname" name="joinnbufc_register_surname" required>
                    </div>
                    <div class="col-12 col-md-2 mt-3">
                        <label for="joinnbufc_register_surname" class="form-label">ชื่อเล่น</label>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-2 mt-3">
                        <label for="joinnbufc_register_birthday" class="form-label">เดือน</label>
                        <select class="form-select" required name="birthdate">
                            <option value=""></option>
                    ...
                    <div class="col-12 col-md-2 mt-3">
                        <label for="birthyear" class="form-label">พ.ศ.</label>
    ...
    -->
                    <div class="col-12 col-md-6 mt-3">
                        <label for="joinnbufc_register_citizen" class="form-label">เลขบัตรประชาชน</label>
                        <input type="text" pattern="[0-9]{13}" class="form-control" id="joinnbufc_register_citizen" name="joinnbufc_register_citizen" required>
                    </div>
                    <div class="col-12 col-md-6 mt-3">
                        <label for="joinnbufc_register_height" class="form-label">ส่วนสูง</label>
                    ...
                    <div class="col-12 col-md-6 mt-3">
                        <label for="joinnbufc_register_weight" min="50" max="100" class="form-label">น้ำหนัก</label>
                ...
                <div class="row mt">
                    <div class="col-12 col-md-2 mt-3">
                        <label for="joinnbufc_register_address" class="form-label">เลขที่</label>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-3 mt-3">
                        <label for="joinnbufc_register_zipcode" class="form-label">รหัสไปรษณีย์</label>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-3 mt-3">
                        <label for="joinnbufc_register_tel" class="form-label">เบอร์โทรศัพท์</label>
                ...
                <div class="row">
                    <div class="col-12 col-md-2 mt-3">
                        <label for="joinnbufc_register_parent_prename" class="form-label">คำนำชื่อ</label>
                ...
                <div class="row">
                    <div class="col-12 col-md-5 mt-3">
                        <label for="joinnbufc_register_parent_tel" class="form-label">เบอร์โทรศัพท์ติดต่อ</label>
                ...
                <div class="row">
                    <div class="col-12 col-md-4 mt-3">
                        <label for="joinnbufc_register_degree" class="form-label">ระดับการศึกษา/กำลังศึกษาอยู่</label>
                    ...
                    <div class="col-12 col-md-4 mt-3" id="divschool">
                        <label for="email" class="form-label">โรงเรียน</label>
                    ...
                    <div class="col-12 col-md-4 mt-3">
                        <label for="joinnbufc_register_gpa" class="form-label">เกรดเฉลี่ยสะสม</label>
                ...
                <h3 class="mt-5">ตำแหน่งที่ขอคัดเลือก เลือกตามลำดับความสนใจอย่างน้อย 1 ตำแหน่ง</h3>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-auto">
                        <select class="form-select" id="joinnbufc_register_position1" name="joinnbufc_register_position1" required>
                            ...
                            <option value="เซนเตอร์">เซนเตอร์</option>
                            <option value="แบ็คขวา">แบ็คขวา</option>
                            <option value="แบ็คซ้าย">แบ็คซ้าย</option>
                            <option value="กองกลาง">กองกลาง</option>
                            <option value="ปีกซ้าย">ปีกซ้าย</option>
                            <option value="ปีกขวา">ปีกขวา</option>
                ...
                <div class="row">
                    <div class="col-12 col-md-3 mt-3">การสมัครเข้าศึกษา</div>
                </div>
